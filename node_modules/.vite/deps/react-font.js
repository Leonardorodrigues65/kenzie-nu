...
// node_modules/react-font/dist/index.modern.js
...
var Font = function Font2(props) {
  return import_react.default.createElement("div", {
    style: styleGen(props)
  }, import_react.default.createElement(FontLoader, Object.assign({}, props)), props.children);
};
var Text = function Text2(props) {
  return import_react.default.createElement("p", Object.assign({}, _extends({}, Object.keys(props).reduce(function(object, key) {
  ...
  }), import_react.default.createElement(FontLoader, Object.assign({}, props, {
    text: props.children
  })), props.children);
};
var FontLoader = function FontLoader2(_ref) {
  var family = _ref.family, _ref$weight = _ref.weight, weight = _ref$weight === void 0 ? 400 : _ref$weight, _ref$italic = _ref.italic, italic = _ref$italic === void 0 ? false : _ref$italic, _ref$provider = _ref.provider, provider = _ref$provider === void 0 ? "google" : _ref$provider, _ref$onLoad = _ref.onLoad, onLoad = _ref$onLoad === void 0 ? function() {
  } : _ref$onLoad, _ref$onError = _ref.onError, onError = _ref$onError === void 0 ? function() {
  } : _ref$onError, _ref$onAllLoad = _ref.onAllLoad, onAllLoad = _ref$onAllLoad === void 0 ? function() {
  } : _ref$onAllLoad, _ref$onAllError = _ref.onAllError, onAllError = _ref$onAllError === void 0 ? function() {
  } : _ref$onAllError, _ref$text = _ref.text, text = _ref$text === void 0 ? void 0 : _ref$text;
  (0, import_react.useEffect)(function() {
    ...
    import_webfontloader.default.load(WebFontConfig);
  }, [family, weight, italic, provider, onLoad, onError]);
  return null;
};
var GoogleFont = function GoogleFont2(_ref2) {
  var family = _ref2.family, _ref2$weight = _ref2.weight, weight = _ref2$weight === void 0 ? 400 : _ref2$weight, _ref2$italic = _ref2.italic, italic = _ref2$italic === void 0 ? false : _ref2$italic;
...
var styleGen = function styleGen2(_ref3) {
  var family = _ref3.family, italic = _ref3.italic, weight = _ref3.weight;
  return {
    fontFamily: "'" + family + "'",
...
var index_modern_default = Font;
export {
  FontLoader,
  Text,
  index_modern_default as default
};
//# sourceMappingURL=react-font.js.map
